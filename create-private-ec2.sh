...
ec2_id=$(aws ec2 run-instances --image-id $ami_id \
        ...
        --network-interfaces '[ { "DeviceIndex": 0, "DeleteOnTermination": true, "AssociatePublicIpAddress": false } ]' \
        --instance-initiated-shutdown-behavior terminate \
        --output text --query 'Instances[*].InstanceId')

echo "EC2 Id:" $ec2_id
aws ec2 create-tags --region $region --resources $ec2_id --tags Key=Name,Value=\"devops-private-ec2\"
